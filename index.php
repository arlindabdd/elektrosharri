...
<html>
	...
	<head>
		...
		<title>Elektrosharri • Green Energy</title>
    ...
    <div class="st-pusher">
            ...
            <div class="st-content-inner">
					...
					<nav class="navbar navbar-default" role="navigation">
						<div class="container">
							<div class="navbar-header">
								...
								<h1 class="logo"><a class="navbar-brand" href="index"><img src="img/logo.png" alt=""></a></h1>
							</div>
				        ...
				        <div class="item active">
				            ...
				            <div class="container">
				                <div class="carousel-caption">
				                    <h1 class="animated lightSpeedIn">WE ARE FIRST BIOGAS PLANT IN OUR COUNTRY</h1>

				                    <p class="lead animated lightSpeedIn">We lightup your future</p>
				        ...
				        <div class="item">
				            ...
				            <div class="container">
				                <div class="carousel-caption">
				                    ...
				                    <h1 class="animated bounceIn">WE PRODUCE ELECTRICITY WITH HIGH QUALITY BIOGAS</h1>

				                    <p class="lead animated bounceIn">We lightup your future</p>
				                </div>
				                <!--.carousel-caption-->
				            </div>
				            <!--.container-->
		        ...
		        <section id="about" class="team-section section-padding">
			        <div class="container">
		              	<div class="row text-center">
		                	<div class="col-xs-12">
		                  		<h2 class="section-title wow zoomIn">Our Story</h2>
		                  		<div class="team-intro wow zoomIn">
		                  			<p>Establishment of the first electricity generation company with biogas was set in 2013.We decided to produce electricity from poultry litter.This was an investment of 5million euros.But this year's dream of this project was more valuable. With a great willingness of partners from Germany and Macedonia this was not a dream, it turned into a very successful investment.
										So this was the story of the beginning of the successes of this company.</p>
		                  		</div>
		                	</div>
		              	</div> <!-- /.row -->
			              	...
			              	<div class="row">
							        ...
							        <figure class="css-hover-effect">
							            ...
							            <figcaption class="figure-caption">
							              <div class="figure-info">
							                <h2> Gajur Abduramani <small>General Director</small></h2>
							              </div>
							            </figcaption>   
							        </figure>
				              	</div><!-- /.col-sm-4 -->
				              	...
				              	<div class="col-sm-4">
							        <figure class="css-hover-effect">
							            ...
							            <figcaption class="figure-caption">
							              <div class="figure-info">
							                <h2>Bujamin Sheapi<small>Electrical Engineer</small></h2>
							              </div>
							            </figcaption>   
							        </figure>
				              	</div><!-- /.col-sm-4 -->
				              	...
				              	<div class="col-sm-4">
							        <figure class="css-hover-effect">
							            ...
							            <figcaption class="figure-caption">
							              <div class="figure-info">
							                <h2>Sabit Xhaferi <small>Mechanical Engineer</small></h2>
							              </div>
							            </figcaption>   
							        </figure>
								  </div><!-- /.col-sm-4 -->
								  <div class="col-sm-4">
							        <figure class="css-hover-effect">
							            ...
							            <figcaption class="figure-caption">
							              <div class="figure-info">
							                <h2>Lazim Jakupi <small>Mechanical Engineer</small></h2>
							              </div>
							            </figcaption>   
							        </figure>
								  </div><!-- /.col-sm-4 -->
			        	...
			        	<div class="container">
							<div class="row text-center">
						        <div class="col-xs-12 col-sm-3">
						          ...
						          <span class="count-description">Years Experienced</span>
						        </div> <!-- /.col-sm-3 -->
						        <div class="col-xs-12 col-sm-3">
						          <strong><span class="timer">999</span>KW</strong>
						          <span class="count-description">per hour</span>
						        </div><!-- /.col-sm-3 -->
						        <div class="col-xs-12 col-sm-3">
						          <strong><span class="timer">8</span>GW</strong>
						          <span class="count-description">per year</span>
						        </div><!-- /.col-sm-3 -->
						        <div class="col-xs-12 col-sm-3">
						          <strong><span class="timer">45</span>TON</strong>
						          <span class="count-description"> material per day</span>
						        </div><!-- /.col-sm-3 -->
					      	</div>
			        	</div><!-- /.container -->
		        	</div><!-- /.css-overlay -->
		        ...
		        <section class="partner-section section-padding">
			        <div class="container">
		              	<div class="row text-center">
		                	<div class="col-xs-12">
		                  		<h2 class="section-title wow zoomIn">Our Clients &amp; Partners</h2>
		                	</div>
		              	</div> <!-- /.row -->
		        ...
		        <section class="call-to-action section-padding">
			        <div class="container">
				        <h2 class="wow zoomIn">We are happy to show you our products.</h2>
					...
					<div class="container">
						...
						<div class="row">
							<div class="col-xs-12 text-center">
								<div class="copyright">
									<p>&copy; 2019 Elektrosharri.  Developed and Designed by : <a href="https://arlindabdurahmani.cf/" title="uiCookies">Arlind Abdurahmani</a></p>
								</div>
							</div>
						</div>
    	...
    	<div class="offcanvas-menu offcanvas-effect visible-xs">
	        ...
	        <ul class="list-unstyled">
				...
				<li><a class="offcanvas-link">Select Language</a></li>
				<li><a href="index">
					<img border="0" alt="" src="img\lang_flags\en.png">
					</a></li>
